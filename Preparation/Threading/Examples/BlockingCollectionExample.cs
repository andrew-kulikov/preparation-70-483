...
namespace Threading.Examples
{
    ...
    /// </summary>
    public class BlockingCollectionExample : Example
    {
        private readonly BlockingCollection<int> _data = new BlockingCollection<int>(4);

        public BlockingCollectionExample() : base("Blocking collection example", "1.1")
        {
        }
